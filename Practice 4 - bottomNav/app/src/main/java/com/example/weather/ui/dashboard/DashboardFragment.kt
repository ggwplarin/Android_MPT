...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = ArrayAdapter(this.requireContext(),android.R.layout.simple_list_item_1,Cities)
        ...
        btn.setOnClickListener {
            ...
            citiesList.adapter = ArrayAdapter(this.requireContext(),android.R.layout.simple_list_item_1,Cities)
        }
